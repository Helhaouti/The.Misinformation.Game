...
```sh
cd existing_repo
 git clone git@gitlab.fdmci.hva.nl:major-cloud-solutions/2324_sem_2/themisinformationgame-1.git
git branch -M main
...
You will need to install the NodeJs to run app.  [Download Here Nodejs](https://nodejs.org/en/download/prebuilt-installer) if you haven't done it already.
```
cd dev
npm start
```
